...
(function () {
    ...
    // Request service
    app.service('configuracaoService', ['$http', 'messageService',
        'locationhostService',
        function ($http, messageService, locationhostService) {
        
            this.apiBase = locationhostService.apiBase + 'api/Configuracao';
            ...
            this.goSaveOrUpdate = function (dto, fn) {
                var data = {
                    Codigo: dto.codigo,
                    Nome: dto.nome,
                    valor: dto.valor, PerfilId: dto.perfil.codigo,
                    PerfilNome: dto.perfil.nome
